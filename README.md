...
Includes:
1. [rpackgages:v3.5.2](https://hub.docker.com/r/tmbuza/rpackages) for R version 3.5.2 and packages selected strategically as fundamental units of reproducible R code.
