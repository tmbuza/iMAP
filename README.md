...
* Read [README2.md](https://github.com/tmbuza/iMAP/blob/master/README2.md): README2.md provides guidance to run iMAP on specific platform, including Unix-Linux and Mac OS X
