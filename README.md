...
```
>If using full length greengenes or any other pretrained QIIME2-formatted classifiers make sure that you change the parameter in the executable file: Below is a location and the file to be altered. Find and replace "gg-13-8-99-515-806-nb-classifier.qza" string with the name of your favorable one.
