...
| *BBduk.sh via BBMap\**      | For trimming poor quality reads and removing phiX contamination    |  Auto-loaded to code folder  | [Link](https://sourceforge.net/projects/bbmap/files/)  |
