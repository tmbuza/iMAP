...
mkdir ~/bin #(if do not exist)
mkdir ~/.bashrc #(if do not exist)
echo "export PATH=$PATH:$HOME/bin" >> /.bashrc  #(append at the end)
source .bashrc
...
echo 'export PATH=$PWD/code/bbmap/bbduk.sh' >> ~/.bashrc 
