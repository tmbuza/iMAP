...
```{r}
load("/myprojects/results/tables/phylotype/otutaxon.RData")
```
...
phylotype_shared <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.seed.wang.pick.pick.tx.shared")
phylotype_shared.v <- cbind(variables, phylotype_shared)



# For rank abundance analysis
phylotyperabund <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.seed.wang.pick.pick.tx.rabund")
dim(phylotyperabund)

# For taxon analysis
phylotypetaxsummary <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.seed.wang.pick.pick.tx.1.cons.tax.summary")
dim(phylotypetaxsummary)

# For taxonomy Venn diagram
phylotypeconstaxonomy <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.seed.wang.pick.pick.tx.1.cons.taxonomy", col_names = TRUE)
dim(phylotypeconstaxonomy)

# For relative abundance analysis
phylotypetaxlefse <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.seed.wang.pick.pick.tx.1.lefse")
dim(phylotypetaxlefse)

# For raw abundance analysis
phylotypetaxbiom <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.seed.wang.pick.pick.tx.1.biom")
dim(phylotypetaxbiom)

#---------------------
dir.create("/myprojects/results/tables/phylotype")
write.table(phylotypeconstaxonomy,"/myprojects/results/tables/phylotype/phylotypeconstaxonomy.tsv", append = FALSE, quote = FALSE, sep="\t", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"), fileEncoding = "")
#---------------------


## OTUbased approach
# For taxon analysis
otubasedtaxsummary <- readr::read_table2(file = "/myprojects/data/mothur/otus/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.0.03.cons.tax.summary")
dim(otubasedtaxsummary)

# For taxonomy Venn diagram
otubasedconstaxonomy <- readr::read_table2(file = "/myprojects/data/mothur/otus/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.0.03.cons.taxonomy", col_names = TRUE)
dim(otubasedconstaxonomy)

# For raw abundance analysis
otubased_shared <- readr::read_table2(file = "/myprojects/data/mothur/otus/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.shared")
dim(otubased_shared)

otubased_shared_2 <- cbind(variables, otubased_shared)
dim(otubased_shared_2)

# For significant statistics
otubasedmccsensspec <- readr::read_table2(file = "/myprojects/data/mothur/otus/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.sensspec")
dim(otubasedmccsensspec)

# For relative abundance analysis
otubasedtaxlefse <- readr::read_table2(file = "/myprojects/data/mothur/otus/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.0.03.lefse")
dim(otubasedtaxlefse)

# For raw abundance analysis
otubasedtaxbiom <- readr::read_table2(file = "/myprojects/data/mothur/otus/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.0.03.biom")

dim(otubasedtaxbiom)


#---------------------
dir.create("/myprojects/results/tables/otus.0.03")
write.table(otubasedconstaxonomy,"/myprojects/results/tables/otus.0.03/otubasedconstaxonomy.tsv", append = FALSE, quote = FALSE, sep="\t", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"), fileEncoding = "")
#---------------------
...
phylogenydiversity <- readr::read_table2(file = "/myprojects/data/mothur/phylogeny/01_rarefy/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.phylip.1.phylodiv.summary", col_names = TRUE)
dim(phylogenydiversity)

# For taxonomy Venn diagram
phylogenyconstaxonomy <- readr::read_table2(file = "/myprojects/data/mothur/phylogeny/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.phylip.taxonomy.summary", col_names = TRUE)
dim(phylogenyconstaxonomy)

#---------------------
dir.create("/myprojects/results/tables/phylogeny")
write.table(phylogenyconstaxonomy,"/myprojects/results/tables/phylogeny/phylogenyconstaxonomy.tsv", append = FALSE, quote = FALSE, sep="\t", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"), fileEncoding = "")

# Create iMAP objects for future use
save(otubased_shared, otubased_shared_2, otubasedconstaxonomy, otubasedmccsensspec, otubasedtaxbiom, otubasedtaxlefse, otubasedtaxsummary, phylogenyconstaxonomy, phylogenydiversity, phylotype_shared, phylotype_shared.v, phylotypeconstaxonomy, phylotyperabund, phylotypetaxlefse, phylotypetaxbiom, phylotypetaxsummary, file = "/myprojects/results/permethodtaxdata.RData")

```


```{r eval=FALSE, include=FALSE}
load("/myprojects/results/permethodtaxdata.RData")
```
...
# taxon4wordcloud <- readr::read_table2(file = "/myprojects/results/tables/wordcloud/merged.tsv")
taxon4wordcloud <- readr::read_table2(file = "/myprojects/results/tables/wordcloud/taxmerged4wordcloud.txt")

phylumwords <- taxon4wordcloud$Phylum
write.table(phylumwords,"/myprojects/results/tables/wordcloud/phylumwords.tsv",sep="\t", row.names = FALSE, col.names = FALSE)
...
write.table(classwords,"/myprojects/results/tables/wordcloud/classwords.tsv",sep="\t", row.names = FALSE, col.names = FALSE)
# Load the data as a corpus
...
write.table(orderwords,"/myprojects/results/tables/wordcloud/orderwords.tsv",sep="\t", row.names = FALSE, col.names = FALSE)
...
write.table(familywords,"/myprojects/results/tables/wordcloud/familywords.tsv",sep="\t", row.names = FALSE, col.names = FALSE)
...
write.table(genuswords,"/myprojects/results/tables/wordcloud/genuswords.tsv",sep="\t", row.names = FALSE, col.names = FALSE)
# Load the data as a corpus
...
richdiv <- readr::read_table2(file = "/myprojects/data/mothur/phylotype/03_summary/qced.otu.groups.summary")
richdiv.v <- cbind(variables, richdiv)

phylodiv <- readr::read_table2(file = "/myprojects/data/mothur/phylogeny/01_rarefy/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.phylip.1.phylodiv.summary")
...
write.table(richdiv, "/myprojects/results/tables/phylotype/richdiv.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(richdiv.v, "/myprojects/results/tables/phylotype/richdiv.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(phylodiv, "/myprojects/results/tables/phylotype/phylodiv.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(phylodiv.v,"/myprojects/results/tables/phylotype/phylodiv.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(richdivphylo.v,"/myprojects/results/tables/phylotype/richdivphylo.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)
...
richdiv <- readr::read_table2(file = "/myprojects/results/tables/phylotype/richdiv.tsv")
phylodiv <- readr::read_table2(file = "/myprojects/results/tables/phylotype/phylodiv.tsv")
richdiv.v <- readr::read_table2(file = "/myprojects/results/tables/phylotype/richdiv.v.tsv")
phylodiv.v <- readr::read_table2(file = "/myprojects/results/tables/phylotype/phylodiv.v.tsv")
richdivphylo.v <- readr::read_table2(file = "/myprojects/results/tables/phylotype/richdivphylo.v.tsv")
```
...
![Example: Figure10 in iMAP paper](/myprojects/img/Figure10.png)
...
```{r inext_qo, message=FALSE, warning=FALSE}
library(iNEXT)

otu_inextrichness <- iNEXT::iNEXT(otu.t,  q=0, datatype="abundance", endpoint = 500)
p_inextrichness <- iNEXT::iNEXT(phylum.t,  q=0, datatype="abundance", endpoint = 500)
c_inextrichness <- iNEXT::iNEXT(class.t,  q=0, datatype="abundance", endpoint = 500)
o_inextrichness <- iNEXT::iNEXT(order.t,  q=0, datatype="abundance", endpoint = 500)
f_inextrichness <- iNEXT::iNEXT(family.t,  q=0, datatype="abundance", endpoint = 500)
g_inextrichness <- iNEXT::iNEXT(genus.t,  q=0, datatype="abundance", endpoint = 500)

otu_inextshannon <- iNEXT::iNEXT(otu.t,  q=1, datatype="abundance", endpoint = 500)
p_inextshannon <- iNEXT::iNEXT(phylum.t,  q=1, datatype="abundance", endpoint = 500)
c_inextshannon <- iNEXT::iNEXT(class.t,  q=1, datatype="abundance", endpoint = 500)
o_inextshannon <- iNEXT::iNEXT(order.t,  q=1, datatype="abundance", endpoint = 500)
f_inextshannon <- iNEXT::iNEXT(family.t,  q=1, datatype="abundance", endpoint = 500)
g_inextshannon <- iNEXT::iNEXT(genus.t,  q=1, datatype="abundance", endpoint = 500)

otu_inextsimpson <- iNEXT::iNEXT(otu.t,  q=2, datatype="abundance", endpoint = 500)
p_inextsimpson <- iNEXT::iNEXT(phylum.t,  q=2, datatype="abundance", endpoint = 500)
c_inextsimpson <- iNEXT::iNEXT(class.t,  q=2, datatype="abundance", endpoint = 500)
o_inextsimpson <- iNEXT::iNEXT(order.t,  q=2, datatype="abundance", endpoint = 500)
f_inextsimpson <- iNEXT::iNEXT(family.t,  q=2, datatype="abundance", endpoint = 500)
g_inextsimpson <- iNEXT::iNEXT(genus.t,  q=2, datatype="abundance", endpoint = 500)

save(otu_inextrichness,	p_inextrichness,	c_inextrichness,	o_inextrichness,	f_inextrichness,	g_inextrichness,	otu_inextshannon,	p_inextshannon,	c_inextshannon,	o_inextshannon,	f_inextshannon,	g_inextshannon,	otu_inextsimpson,	p_inextsimpson,	c_inextsimpson,	o_inextsimpson,	f_inextsimpson,	g_inextsimpson, file = "/myprojects/results/iNEXT.RData")
...
```{r}
load("/myprojects/results/iNEXT.RData")
```
...
```{r inexttyp3, fig.height=10, fig.width=12, message=FALSE, warning=FALSE}
library(iNEXT)
library(ggplot2)
...
```{r invsimpson, fig.height=10, fig.width=12, message=FALSE, warning=FALSE}
...
```{r inextdiverity, eval=FALSE, fig.height=10, fig.width=12, message=FALSE, warning=FALSE}
...
# save(otu.mds,p.mds,c.mds,o.mds,f.mds,g.mds, file = "/myprojects/results/mds.RData")
# ```


# ```{r echo=FALSE}
# load(file = "/myprojects/results/mds.RData")
# ```
...
# ![](/myprojects//img/phyloclusters.png)
...
# <!-- write.table(colongenera,"/myprojects//myprojects//results/tables/colongenera.tsv", append = FALSE, quote = FALSE, sep="\t", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"), fileEncoding = "") -->
