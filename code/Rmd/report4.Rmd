...
richdiv.v <- cbind(variables2, richdiv)
...
phylodiv.v <- cbind(variables2, phylodiv)
...
richdivphylo.v$Sex <- as.factor(richdivphylo.v$Sex)
richdivphylo.v$Time <- as.factor(richdivphylo.v$Time)
...
boxspprich <- ggboxplot(richdivphylo.v, x = "Time", y = "sobs", fill = "Time", color = "Time",
          ...
          legend.title = "Calculator") +  xlab("Time of weaning") + ylab("Species richness") + ggtitle("") + facet_grid(~ Sex) + theme_gray()
...
sobsvsseqdepth3 <- ggboxplot(richdivphylo.v, x = "Time", y = "sobs", fill = "Time", color = "Time",
                palette =c("#00AFBB", "#E7B800"), width = 1, notch = TRUE,
                add = "jitter", shape = 19, alpha = 0.5,
          legend.title = "Calculator") +  xlab("Time of weaning") + ylab("Observed richness") + ggtitle("") + facet_grid(~ Sex) + formatPlot3 + ybreaks5


chaovsseqdepth1 <- ggline(
  richdivphylo.v, x = "chao", y = "nseqs", color = "Time",  palette =c("#00AFBB", "#E7B800"), 
  add = "none", shape = 19) +
...
chaovsseqdepth3 <- ggboxplot(richdivphylo.v, x = "Time", y = "chao", fill = "Time", color = "Time",
                palette =c("#00AFBB", "#E7B800"), width = 1, notch = TRUE,
                add = "jitter", shape = 19, alpha = 0.5,
          legend.title = "Calculator") +  xlab("Time of weaning") + ylab("Estimated richness") + ggtitle("") + facet_grid(~ Sex) + formatPlot3 + ybreaks5


invsppdiv1 <- ggline(
  richdivphylo.v, x = "sobs", y = "invsimpson", color = "Time",  palette =c("#00AFBB", "#E7B800"), 
  add = "none", shape = 19) +
...
invsppdiv3 <- ggboxplot(richdivphylo.v, x = "Time", y = "invsimpson", fill = "Time", color = "Time",
                palette =c("#00AFBB", "#E7B800"), width = 1, notch = TRUE,
                add = "jitter", shape = 19, alpha = 0.5,
          legend.title = "Calculator") +  xlab("Time of weaning") + ylab("Species richness") + ggtitle("") + facet_grid(~ Sex) + formatPlot3 + ybreaks5


shansppdiv1 <- ggline(
  richdivphylo.v, x = "sobs", y = "npshannon", color = "Time",  palette =c("#00AFBB", "#E7B800"), 
  add = "none", shape = 19) +
...
shansppdiv3 <- ggboxplot(richdivphylo.v, x = "Time", y = "npshannon", fill = "Time", color = "Time",
                palette =c("#00AFBB", "#E7B800"), width = 1, notch = TRUE,
                add = "jitter", shape = 19, alpha = 0.5,
          legend.title = "Calculator") +  xlab("Time of weaning") + ylab("Species richness") + ggtitle("") + facet_grid(~ Sex) + formatPlot3 + ybreaks5
...
phylopdiv1 <- ggline(
  richdivphylo.v, x = "sobs", y = "phyloDiversity", color = "Time",  palette =c("#00AFBB", "#E7B800"), 
  add = "none", shape = 19) +
...
phylopdiv3 <- ggboxplot(richdivphylo.v, x = "Time", y = "phyloDiversity", fill = "Time", color = "Time",
                palette =c("#00AFBB", "#E7B800"), width = 1, notch = TRUE,
                add = "jitter", shape = 19, alpha = 0.5,
          legend.title = "Calculator") +  xlab("Time of weaning") + ylab("Species richness") + ggtitle("") + facet_grid(~ Sex) + formatPlot3 + ybreaks5


ggpubr::ggarrange(sobsvsseqdepth1, sobsvsseqdepth2, sobsvsseqdepth3, chaovsseqdepth1, chaovsseqdepth2, chaovsseqdepth3, invsppdiv1, invsppdiv2, invsppdiv3, shansppdiv1, shansppdiv2, shansppdiv3, phylopdiv1, phylopdiv2, phylopdiv3, ncol = 3, nrow = 5,  common.legend = TRUE, legend = "top", align = "hv", labels = "AUTO")
