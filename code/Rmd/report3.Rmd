...
barforintext <- ggplot(seqcount.v.m, aes(x = variable, y = value, fill= variable)) +
  ...
  theme(axis.title=element_text(size=14,face="bold")) + 
  scale_y_continuous(breaks=pretty_breaks(n=8)) +
  theme(legend.position="top") + formatPlot
# barforintext
...
boxforintext <- ggplot(seqcount.v.m, aes(x = variable, y = value)) +
  ...
  theme(axis.title=element_text(size=14,face="bold")) +
    nolegend +
  scale_y_continuous(breaks=pretty_breaks(n=8)) +
  theme(axis.text.x = element_text(hjust=0.5)) + formatPlot
# boxforintext
...
```{r paper_procplots, fig.height=14, fig.width=14, message=FALSE, warning=FALSE}
...
middle_row1<- cowplot::plot_grid(plots[[2]], labels = "", align = 'h')
middle_row2 <- cowplot::plot_grid(plots[[3]], timeintext_densplot, labels = "", align = 'h', rel_widths = c(1, 1))
bottom_row <- cowplot::plot_grid(plots[[4]], timeintext_histplot, labels = "", align = 'h', rel_widths = c(1, 1))

ggpubr::ggarrange(top_row, middle_row1,  middle_row2, bottom_row, ncol = 1, nrow=4, common.legend = TRUE, legend = "top", align = "hv", labels = "AUTO", rel_heights = c(1.8, 1.2, 1.4, 1.4))
