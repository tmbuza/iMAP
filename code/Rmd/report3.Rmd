...
ggpubr::ggarrange(seqlen, overlaplen, mismatch, ncol = 3, nrow = 2, align = "hv", labels = "AUTO", font.label = list(size = 12, color = "black", face = "bold", family = NULL))
```
...
## Publication-ready figure: Assembled and aligned sequences
