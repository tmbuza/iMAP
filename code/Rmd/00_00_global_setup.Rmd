...
knitr::opts_chunk$set(fig.path='./figures/', fig.show='asis',  dev = 'png', fig.align='center', out.width = "80%",  out.height = "80%", echo=FALSE, comment = NA, warning=FALSE, message=FALSE)

# Load packages
if (!require("ggplot2")) {install.packages("ggplot2", dependencies = TRUE)}
library(ggplot2)
if (!require("tidyverse")) {update.packages("tidyverse", dependencies = TRUE)}
library(tidyverse)
...
library("servr")
if (!require("bookdownplus")) {install.packages("bookdownplus", dependencies = TRUE)}
