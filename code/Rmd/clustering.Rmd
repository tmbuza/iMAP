...
p.scaled.t[,1:4] %>% head(5) %>% kable(align = "c") %>% kable_styling(bootstrap_options = "bordered", full_width = FALSE) %>%
footnote(general = "Phylum-Level: First few columns of the scaled abundance")
...
ggplot(aes(x=Var1, y=Var2, fill=value)) + 
  ...
  # scale_fill_gradient2(low = c("blue","blue4"), high = c("red", "red"), na.value = "white", name  ="Scaled abund") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x="Sample ID", y="", fill ="Scaled Abund") + theme(axis.text.y = element_text(face = "italic", size = 10)) +
...
c.scaled.t[,1:4] %>% head(5) %>% kable(align = "c") %>% kable_styling(bootstrap_options = "bordered", full_width = FALSE) %>%
footnote(general = "Class-Level: First few columns of the scaled abundance")
...
o.scaled.t[,1:4] %>% head(5) %>% kable(align = "c") %>% kable_styling(bootstrap_options = "bordered", full_width = FALSE) %>%
footnote(general = "Order-Level: First few columns of the scaled abundance")
...
f.scaled.t[,1:4] %>% head(5) %>% kable(align = "c") %>% kable_styling(bootstrap_options = "bordered", full_width = FALSE) %>%
footnote(general = "Family-Level: First few columns of the scaled abundance")
...
g.scaled.t[,1:4] %>% head(5) %>% kable(align = "c") %>% kable_styling(bootstrap_options = "bordered", full_width = FALSE) %>%
footnote(general = "Genus-Level: First few columns of the scaled abundance")
...
par(mfrow=c(2,3))
par(cex.axis=1.2, cex.lab=1.2, cex.main=15, cex.sub=1)
