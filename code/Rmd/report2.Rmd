...
xbreaks5 <- scale_x_continuous(labels = comma, breaks=scales::pretty_breaks(n=5))
xbreaks10 <- scale_x_continuous(labels = comma, breaks=scales::pretty_breaks(n=10))
xbreaks15 <- scale_x_continuous(labels = comma, breaks=scales::pretty_breaks(n=15))

ybreaks5 <- scale_y_continuous(labels = comma, breaks=scales::pretty_breaks(n=5))
ybreaks10 <- scale_y_continuous(labels = comma, breaks=scales::pretty_breaks(n=10))
ybreaks15 <- scale_y_continuous(labels = comma, breaks=scales::pretty_breaks(n=15))
noxticks <- theme(axis.text.x=element_blank())
...
readboxplot <- ggboxplot(f_readcount.v.m, x = "Time", y = "value",
   color = "variable", palette =c("#00AFBB", "#E7B800", "#FC4E07"),
   add = "jitter", shape = "variable") +  xlab("") + ylab("Number of reads") + ggtitle("") + facet_grid(~ Sex) + theme(axis.text.x = element_text(size=10,angle = 0, hjust = 0)) +
