...
library(ggplot2)
samplemetadata_casestudy <- readr::read_table2(file="../../data/metadata/samplemetadata_casestudy.txt", col_names = T)
colnames(samplemetadata)[1] <- "SampleID"
...
samplemetadata <- readr::read_table2(file="../../data/metadata/186samples.metadata", col_names = T)
colnames(samplemetadata)[1] <- "SampleID"
