...
samplemetadata$origID <- as.factor(samplemetadata$origID)
samplemetadata$Sex <- as.factor(samplemetadata$Sex)
samplemetadata$DayID <- as.factor(samplemetadata$DayID)
samplemetadata$DPW <- as.factor(samplemetadata$DPW)
