...
library(ggplot2)
samplemetadata_casestudy <- readr::read_table2(file="/myprojects/data/metadata/samplemetadata_casestudy.txt", col_names = T)
colnames(samplemetadata)[1] <- "SampleID"
...
```{r bushmeat, echo=FALSE, fig.height=8, fig.width=10, message=FALSE, warning=FALSE}
samplemetadata <- readr::read_table2(file="/myprojects/data/metadata/186samples.metadata", col_names = T)
colnames(samplemetadata)[1] <- "SampleID"
