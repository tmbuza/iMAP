...
save(samplemetadata, file = "metadatavars.RData")
```
...
# Var1
var1histplot <- ggpubr::gghistogram(variables, x = "Var1", stat="count", fill = "#ff0000") + ggtitle("Sex variable")

# Var2
var2histplot <- ggpubr::gghistogram(variables, x = "Var2", stat="count", fill = "#00ff00") + ggtitle("Time variable")

# Var3
var3histplot <- ggpubr::gghistogram(variables, x = "Var3", stat="count", fill = "#0000ff") + ggtitle("Days post weaning")+
  theme(axis.text.x=element_text(angle = 90, hjust = 0))+ scale_y_continuous(labels=scaleFUN)

ggpubr::ggarrange(var1histplot,var2histplot, var3histplot, ncol = 1, nrow = 3,  common.legend = TRUE, legend = "top", align = "hv", labels = c(""))
```
