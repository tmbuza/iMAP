...
~/bin/seqkit stat ./data/raw/qced/*R1*.fastq.gz -o ./results/stats/qced/R1qcstats.txt
~/bin/seqkit stat ./data/raw/qced/*R2*.fastq.gz -o ./results/stats//qced/R2qcstats.txt
