...
paste -d'\t' ./data/mothur/phylotype/00_processed_seqs/qced.contigs.count.summary ./data/mothur/phylotype/00_processed_seqs/qced.trim.contigs.good.count.summary ./data/mothur/phylotype/00_processed_seqs/qced.trim.contigs.good.good.count.summary  ./data/mothur/phylotype/00_processed_seqs/qced.trim.contigs.good.unique.good.filter.unique.precluster.count.summary ./data/mothur/phylotype/00_processed_seqs/qced.trim.contigs.good.unique.good.filter.unique.precluster.denovo.vsearch.pick.count.summary ./data/mothur/phylotype/00_processed_seqs/qced.trim.contigs.good.unique.good.filter.unique.precluster.denovo.vsearch.pick.pick.pick.count.summary >./data/mothur/phylotype/00_processed_seqs/seqdepth2.tsv

echo -e "SampleID\tOriginal\tScreened\tAligned\tPDenoised\tNonChimeric\tBacteriaOnly\tNoMock" >results/tables/processedSeqs.tsv
cut -f1,2,4,6,8,10,12,14 ./data/mothur/phylotype/00_processed_seqs/seqdepth2.tsv >>results/tables/processedSeqs.tsv
